...
c2_list = []
c5_list = []
readWb = openpyxl.load_workbook("G:\\PycharmProjects\\InvitationCount\\readData2.xlsx")
readSheet = readWb.get_sheet_by_name("groupName")
first_col = readSheet['A']

updateWb = openpyxl.load_workbook("G:\\PycharmProjects\\InvitationCount\\update2.xlsx")

conn = pymssql.connect("localhost", "sa", "admin", "muhin_6.1test")
c1 = conn.cursor()
